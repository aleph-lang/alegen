...
fn gen(ast: at, indent: i64) -> String {
    ...
    match ast {
        ...
        at::LetRec{name, args, body} => format!("{}fun {}({}) = {{\n{}\n{}}}", c_indent, name, gen::gen_list_expr_sep(args, gen, ", "), gen(*body, indent+1), c_indent),
        ...
        at::App{object_name, fun, param_list} => format!("{}{}{}({})",c_indent, (if object_name.ne("") {format!("{}.", object_name)} else {String::from("")}), gen(*fun, 0), gen::gen_list_expr_sep(param_list, gen, ", ")),
